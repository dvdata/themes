...
function(t, e) {
    ...
    function n() {
        ...
        function e() {
            u = s.clientWidth + 10, c = s.clientHeight + 10, l = u > c ? u : c, i.width = u, i.height = c, o.graphics.clear().beginFill("#000000").drawRect(0, 0, u, c), r.update()
        }
        ...
        var s = document.getElementById("index_slider_container"),
            ...
            c = s.clientHeight + 10,
            l = u > c ? u : c;
        i.width = u, i.height = c, o.graphics.beginFill("#000000").drawRect(0, 0, u, c), a.graphics.beginFill("#000000").drawCircle(u / 2, c / 2, 0), r.addChild(o, a), r.update(), window.addEventListener("resize", e), n.Ticker.addEventListener("tick", r), a._count = 0, n.Tween.get(a).wait(2800).to({
            _count: 1
...
var aText = new Array(
"SMI Contracting, LLC preconstruction, general contracting, construction management, you can count on us."
);
